      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="form-group">
            ...
            <input id="evt-name" name="name" type="text" className="form-input" placeholder="Jane Smith" required />
          </div>

          <div className="form-group">
            <label htmlFor="evt-role">Role / profession</label>
            <input id="evt-role" name="role" type="text" className="form-input" placeholder="e.g. Registered Nurse, Physician" />
          </div>

          <div className="form-group">
            <label htmlFor="evt-org">Organization / hospital</label>
            <input id="evt-org" name="org" type="text" className="form-input" placeholder="e.g. London Health Sciences Centre" />
          </div>

          <div className="form-group">
            <label htmlFor="evt-email">Work email</label>
            <input id="evt-email" name="email" type="email" className="form-input" placeholder="you@organization.ca" required />
          </div>

          <p className="form-subhead">Program interest</p>
